...
public class suggestions_adapter extends SuggestionsAdapter<LandInfo, suggestions_adapter.SuggestionHolder> {

    public suggestions_adapter(LayoutInflater inflater) {
        super(inflater);
    ...
    public SuggestionHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = getLayoutInflater().inflate(R.layout.search_suggestions_list, parent, false);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if(term.isEmpty())
                    ...
                    for (LandInfo item: suggestions_clone)
                        if(item.getLandcode().toLowerCase().contains(term.toLowerCase()))
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                suggestions = (ArrayList<LandInfo>) results.values;
